...
class SectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('secret.section.list',compact('user','page_title','sections'));
    }
    public function add()
    {
        $user = Auth::user();
        $page_title = __('Sections');  
        return view('secret.section.add',compact('user','page_title'));
    }
    public function edit($id)
    {
        ...
        return view('secret.section.edit',compact('user','page_title','section'));
    }
    ...
    public function section_create(Request $request)
    {
        ...
        $event_msg = '';
        if (app()->getLocale() == 'en')
            $event_msg = 'New section created by  ' 
                . $user->userinfo->fname. ' '
