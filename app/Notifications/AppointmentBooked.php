...
class AppointmentBooked extends Notification
{
    ...
    public function __construct($notify_method, $to_addr,$message, $qrcode ='')
    {
        $this->notify_method = $notify_method;
    ...
    {     
        ...
        if (app()->getLocale() == 'en')
            return  (new MailMessage)->subject($mission->name)->view('emails.notify',['text'=>$this->message,'qrcode'=>$this->qrcode,'mission'=>$mission]);                
        else
            return  (new MailMessage)->subject($mission->name_ar)->view('emails.notify',['text'=>$this->message,'qrcode'=>$this->qrcode,'mission'=>$mission]);                
    }
