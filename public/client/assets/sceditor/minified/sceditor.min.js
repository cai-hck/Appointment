/* SCEditor v2.1.3 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function() {
    "use strict";
    ...
    function nt(e, t) {
        ...
        for (Se(e.attributes, function(e, t) {
            ...
            }); e.firstChild;) Fe(n, e.firstChild);
    ...
    function at(e) {
        var t, n, o, r, i, a, l, c = Pe(e, "whiteSpace"),
            s = /line$/i.test(c),
            u = e.firstChild;
        if (!/pre(\-wrap)?$/i.test(c))
            for (; u;) {
                if (a = u.nextSibling, t = u.nodeValue, (n = u.nodeType) === Ee && u.firstChild && at(u), n === Te) {
                    ...
                    if (rt(u) && r) {
                        for (i = r; i.lastChild;)
                            for (i = i.lastChild; qe(i, "sceditor-ignore");) i = d(i, !0);
    ...
    var n, p, m, ct = {
            ...
            emoticons: {
                dropdown: {
                    ":)": "../../client/assets/sceditor/emoticons/smile.png",
                    ":angel:": "../../client/assets/sceditor/emoticons/angel.png",
                    ":angry:": "../../client/assets/sceditor/emoticons/angry.png",
                    "8-)": "../../client/assets/sceditor/emoticons/cool.png",
                    ":'(": "../../client/assets/sceditor/emoticons/cwy.png",
                    ":ermm:": "../../client/assets/sceditor/emoticons/ermm.png",
                    ":D": "../../client/assets/sceditor/emoticons/grin.png",
                    "<3": "../../client/assets/sceditor/emoticons/heart.png",
                    ":(": "../../client/assets/sceditor/emoticons/sad.png",
                    ":O": "../../client/assets/sceditor/emoticons/shocked.png",
                    ":P": "../../client/assets/sceditor/emoticons/tongue.png",
                    ";)": "../../client/assets/sceditor/emoticons/wink.png"
                },
                more: {
                    ":alien:": "../../client/assets/sceditor/emoticons/alien.png",
                    ":blink:": "../../client/assets/sceditor/emoticons/blink.png",
                    ":blush:": "../../client/assets/sceditor/emoticons/blush.png",
/*                     ":cheerful:": "../../client/assets/sceditor/moticons/cheerful.png", */
                    ":devil:": "../../client/assets/sceditor/emoticons/devil.png",
                    ":dizzy:": "../../client/assets/sceditor/emoticons/dizzy.png",
                    ":getlost:": "../../client/assets/sceditor/emoticons/getlost.png",
                    ":happy:": "../../client/assets/sceditor/emoticons/happy.png",
                    ":kissing:": "../../client/assets/sceditor/emoticons/kissing.png",
                    ":ninja:": "../../client/assets/sceditor/emoticons/ninja.png",
                    ":pinch:": "../../client/assets/sceditor/emoticons/pinch.png",
                    ":pouty:": "../../client/assets/sceditor/emoticons/pouty.png",
                    ":sick:": "../../client/assets/sceditor/emoticons/sick.png",
                    ":sideways:": "../../client/assets/sceditor/emoticons/sideways.png",
                    ":silly:": "../../client/assets/sceditor/emoticons/silly.png",
                    ":sleeping:": "../../client/assets/sceditor/emoticons/sleeping.png",
                    ":unsure:": "../../client/assets/sceditor/emoticons/unsure.png",
                    ":woot:": "../../client/assets/sceditor/emoticons/w00t.png",
                    ":wassat:": "../../client/assets/sceditor/emoticons/wassat.png"
                },
                hidden: {
                    ":whistling:": "../../client/assets/sceditor/emoticons/whistling.png",
                    ":love:": "../../client/assets/sceditor/emoticons/wub.png"
                }
            },
            width: null,
            height: null,
    ...
    var gt = {
            ...
            size: {
                _dropDown: function(t, e, n) {
                    ...
                    for (var r = 1; r <= 7; r++) Fe(o, mt("sizeOpt", {
                        size: r
                    }, !0));
        ...
        var r = this,
            ...
            e = function(e, t) {
                ...
                for (n = 0; n < a.length; n++)
                    if (r in a[n] && (o = a[n][r].apply(i, e), t)) return o
            };
        r.call = function() {
            e(arguments, !1)
            ...
            for (; n--;) a[n] instanceof w[e] && (o = !0, "destroy" in (t = a.splice(n, 1)[0]) && t.destroy.call(i));
            return o
        }, r.destroy = function() {
    ...
    var C = h && h < 11,
        k = function(e, t, n) {
            var o, r, i, a, l, c = "",
                s = e.startContainer,
                u = e.startOffset;
            for (s && 3 !== s.nodeType && (s = s.childNodes[u], u = 0), i = a = u; n > c.length && s && 3 === s.nodeType;) o = s.nodeValue, r = n - c.length, l && (a = o.length, i = 0), l = s, t ? (u = i = Math.max(a - r, 0), c = o.substr(i, a - i) + c, s = l.previousSibling) : (u = i + (a = Math.min(r, o.length)), c += o.substr(i, a), s = l.nextSibling);
            return {
                node: l || s,
                offset: u,
                text: c
    ...
    function vt(i, e) {
        var a, l, c = e || i.contentDocument || i.document,
        ...
        y.insertHTML = function(e, t) {
            ...
            for (t && (e += y.selectedHtml() + t), o = De("p", {}, c), n = c.createDocumentFragment(), o.innerHTML = e; o.firstChild;) Fe(n, o.firstChild);
            y.insertNode(n)
        }, l = function(e, t, n) {
    ...
    function kt(l, e) {
        var a, w, u, c, i, m, d, s, f, p, g, h, t, v, r, y, b, x, C, n, o, k, S, E, T, D, M, N, R, F, H, _, z, O, A, B, I, L, P, V, W, j, q, U, $, Y, K, X, G, J, Q, Z, ee, te, ne, oe, re, ie, ae, le, ce, se, ue, de = this,
            fe = {},
            pe = [],
            me = [],
            ge = {},
        ...
        de.opts.emoticons = e.emoticons || ct.emoticons, M = function() {
            ...
            ze(bt, "click", X), e && (ze(e, "reset", U), ze(e, "submit", de.updateOriginal, _e)), ze(m, "keypress", q), ze(m, "keydown", W), ze(m, "keydown", j), ze(m, "keyup", Z), ze(m, "blur", le), ze(m, "keyup", ce), ze(m, "paste", P), ze(m, t, Y), ze(m, o, ee), ze(m, n, K), ye.emoticonsCompat && yt.getSelection && ze(m, "keyup", re), ze(m, "blur", function() {
                de.val() || Ue(m, "placeholder")
            }), ze(m, "focus", function() {
                $e(m, "placeholder")
            }), ze(s, "blur", le), ze(s, "keyup", ce), ze(s, "keydown", W), ze(s, t, Y), ze(s, n, K), ze(d, "mousedown", $), ze(d, o, ee), ze(d, "beforedeactivate keyup mouseup", F), ze(d, "keyup", Z), ze(d, "focus", function() {
                p = null
            ...
            var o, r, i, a, t, n, e = De("div", {
                ...
                y = !1,
                b = de.rtl();
            if (o = ye.resizeMinHeight || v / 1.5, r = ye.resizeMaxHeight || 2.5 * v, i = ye.resizeMinWidth || h / 1.25, a = ye.resizeMaxWidth || 1.25 * h, t = function(e) {
            ...
            Fe(w, e), Fe(w, l), Be(l), ze(e, "touchstart mousedown", function(e) {
                "touchstart" === e.type ? (e = yt.event, u = e.touches[0].pageX, d = e.touches[0].pageY) : (u = e.pageX, d = e.pageY), m = Ke(w), g = Xe(w), y = !0, Ue(w, "resizing"), Ie(l), ze(bt, c, t), ze(bt, s, n), e.preventDefault()
            })
        }, L = function() {
            var e = ye.emoticons,
                n = ye.emoticonsRoot || "";
            ...
            var e, t, n = m.firstChild,
                o = !!ye.autofocusEnd;
            if (Je(w)) {
                if (de.sourceMode()) return t = o ? s.value.length : 0, void s.setSelectionRange(t, t);
                if (at(m), o)
                    for ((n = m.lastChild) || (n = De("p", {}, d), Fe(m, n)); n.lastChild;) n = n.lastChild, !wt && We(n, "br") && n.previousSibling && (n = n.previousSibling);
            ...
            var o, r, i, a = Xe(c);
            de.focus(), !n && Ne(b, "code") || (v.insertHTML(e, t), v.saveRange(), N(), Ie(o = He(m, "#sceditor-end-marker")[0]), r = m.scrollTop, i = lt(o).top + 1.5 * o.offsetHeight - a, Be(o), (r < i || i + a < r) && (m.scrollTop = i), ae(!1), v.restoreRange(), Z())
            ...
            var n, o, r = s.selectionStart,
                i = s.selectionEnd;
            n = s.scrollTop, s.focus(), o = s.value, t && (e += o.substring(r, i) + t), s.value = o.substring(0, r) + e + o.substring(i, o.length), s.selectionStart = r + e.length - (t ? t.length : 0), s.selectionEnd = s.selectionStart, s.scrollTop = n, s.focus(), ae()
            ...
            if (de.focus(), !Ne(v.parentNode(), "code")) {
                ...
                } catch (e) {}!n && o && o.errorMessage && alert(de._(o.errorMessage)), J()
            }
        }, ee = function() {
            function e() {
                if (i.getSelection() && i.getSelection().rangeCount <= 0) x = null;
                    ...
                    if ((x = v.cloneSelected()) && x.collapsed) {
                        var e = x.startContainer,
                            t = x.startOffset;
                        for (t && e.nodeType !== Te && (e = e.childNodes[t]); e && e.parentNode !== m;) e = e.parentNode;
            ...
            for (var r = (e = e.split(" ")).length; r--;)
                if (we(t)) {
                    var i = "scewys" + e[r],
                        a = "scesrc" + e[r];
                    n || (fe[i] = fe[i] || [], fe[i].push(t)), o || (fe[a] = fe[a] || [], fe[a].push(t)), "valuechanged" === e[r] && (ae.hasHandler = !0)
                } return de
        }, de.unbind = function(e, t, n, o) {
            for (var r = (e = e.split(" ")).length; r--;) we(t) && (n || ke(fe["scewys" + e[r]] || [], t), o || ke(fe["scesrc" + e[r]] || [], t));
            return de
            ...
            (ye.emoticonsEnabled = e) ? (ze(m, "keypress", oe), de.sourceMode() || (v.saveRange(), N(), ae(!1), v.restoreRange())) : (Se(He(m, "img[data-sceditor-emoticon]"), function(e, t) {
            ...
            if (r && (r.hasHandler("valuechangedEvent") || ae.hasHandler)) {
                var t, n = de.sourceMode(),
                    o = !n && v.hasSelection();
                e = (g = !1) !== e && !d.getElementById("sceditor-start-marker"), h && (clearTimeout(h), h = !1), o && e && v.saveRange(), (t = n ? s.value : m.innerHTML) !== ae.lastVal && (ae.lastVal = t, Ge(w, "valuechanged", {
                    rawValue: n ? de.val() : t
                })), o && e && v.removeMarkers()
            }
        }, le = function() {
            ...
            var t = e.which,
                ...
                o = 13 === n || 32 === n,
                r = 8 === n || 46 === n;
            ce.lastChar = t, g || (13 === t || 32 === t ? o ? ce.triggerNext = !0 : ae() : 8 === t || 46 === t ? r ? ce.triggerNext = !0 : ae() : ce.triggerNext && (ae(), ce.triggerNext = !1), clearTimeout(h), h = setTimeout(function() {
                g || ae()
            }, 1500))
        }, Y = function(e) {
