    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="col-auto text-right float-right ml-auto">
                <a href="{{url('consul/sections/add')}}" class="btn btn-primary "><i class="fa fa-plus mr-1"></i>{{__('Add Section') }}</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    //dd(json_decode($creator->photo)->s);
                                ?>
                            ...
                            <td class="text-right">
                                <div class="table-action">
                                    <a href="{{url('consul/sedit/'. $one->id)}}" class="btn btn-sm bg-info-light">
...
<script>
    $(document).ready(function(){
        $('.del-section').click(function(){
            $('#del-form').attr('action',"{{url('consul/deletesection')}}");
