...
@section('page-css')
<!-- <link rel="stylesheet" href="{{ asset('client/assets/sceditor/minified/themes/default.min.css') }}" /> -->
...
<div class="card">
    <div class="card-body">
        <form action="{{url('consul/sections/add')}}" method="POST">
        @include('alert')
        @csrf

        <h4 class="card-title">{{ __('Create new Section') }}</h4>
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="en_about"  type="text" class="form-control" rows="10" required name="en_about"></textarea>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label>{{__('General Info')}}  ({{__('Arabic')}})<span class="text-danger">*</span></label>
                        <textarea id="ar_about" type="text" class="form-control" rows="10" required name="ar_about"></textarea>
                    </div>
                </div>              
            </div>
            ...
            <div class="col-md-4">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="has_meeting_type">
                            <option value="">Choose Meeting Type</option>
                            <option value="both">{{__('Both Online & Onsite Meetings') }}</option>
                            <option value="onsite">{{__('Only Onsite Meetings') }}</option>
                            <option value="online">{{__('Only Online Meetings') }}</option>
                        </select>
                    </div>
                    <div class="form-group">                    
...
$(document).ready(function() {
    ...
    $('.add-require-doc').click(function(){
        ...
        child +=' </td>';
        child += '<td><label >'+ label_en +'</label><br><label >'+ label_ar +'</label></td>';      
        child += '<td class="text-center"><a class="btn btn-sm btn-danger chk-del mt-2" href="javascript:void(0);"><i class="fa fa-trash"></i></a></td>';
        child += '</tr>';
