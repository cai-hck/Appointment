...
<div class="card">
    <div class="card-body">
        <form action="{{url('consul/sections/update')}}" method="POST">
        @include('alert')
        @csrf
...
@section('page-js')
<!-- <script src="{{ asset('client/assets/sceditor/minified/sceditor.min.js') }}"></script> -->
<!-- Include the BBCode or XHTML formats -->
<!-- 
<script src="{{ asset('client/assets/sceditor/minified/icons/monocons.js') }}"></script>
<script src="{{ asset('client/assets/sceditor/minified/formats/bbcode.js') }}"></script> -->
