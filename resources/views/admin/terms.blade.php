...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
            <form action="{{url('admin/extraterm/en')}}" method="post">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="en_about"  type="text" class="form-control" rows="15" required name="en_about">{{$setting['en_term']!=false?$setting['en_term']:''}}</textarea>
                    </div>
                </div>
            </form>
            </div>
            <div class="col-md-6">
            <form action="{{url('admin/extraterm/ar')}}" method="post">
                @csrf
                <div class="col-md-12">
                    <div class="submit-section submit-btn-bottom text-right">
                        <button type="submit" class="btn btn-primary">Save Content</button>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="ar_about"  type="text" class="form-control" rows="15" required name="ar_about">{{$setting['ar_term']!=false?$setting['ar_term']:''}}</textarea>
                    </div>
                </div>
            </div>    
            </form>        
