...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-8">
                    <h3 class="page-title">Secretaries</h3>
                    <ul class="breadcrumb">
                            ...
                            <table class="datatable table table-hover table-center mb-0">
                                ...
                                @foreach ($secrets as $one)
                                    <tr>
                                        ...
                                        <td> 
                                            <?php 
												$sub_consuls = DB::table('consultants')->where('mission_id', $one->mission->id)->get();
                                            ?>
                                        ...
                                        <td class="text-right">
                                            <div class="actions">                                                                                                             
                                                <a class="btn btn-sm bg-success-light" href="{{url('admin/consultant/edit/sub/'.$one->user_id)}}">
