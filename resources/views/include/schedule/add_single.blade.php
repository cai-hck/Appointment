    ...
    <div class="card-body">
            ...
            <div class="alert alert-danger alert-block">
                <button type="button" class="close" data-dismiss="alert">×</button>	
                    <strong>Already have schedule on {{$old_sch->date}}. Please choose different date.</strong>
            </div>
            @endif
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#datepicker').change(function(){
                ...
                window.location.href = "{{url('schedules/addsingle?date=')}}" + new_date ;
                }, 1000);
            });
            /* Slot Modal */
            ...
            $('#add_slot_popsave').click(function(){
                /* var slot_index = ;"<?php //echo rand(10000, 999999) ?>"; */
