...
<div class="card">
    <div class="card-body">
            @include ('alert')
            <h4 class="card-title">{{__('Edit Schedule')}} -  {{$sel_date}} , {{\Carbon\Carbon::parse($sel_date)->format('l')}}</h4>           
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover table-center mb-0  table-bordered">
                                ...
                                <tbody id="slot-custom-body" style="display:{{$schedule->isDefault?'none':''}}">
                                    @if (!$schedule->isDefault && $schedule->timings != '') 
                                ...
                                <tbody id="slot-default-body"  style="display:{{!$schedule->isDefault?'none':''}}">  
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$one->type?'Onsite':'Online'}} Meeting</td>
...
<script>
    $(document).ready(function(){
        <?php if ($schedule->isDefault ==  true) {?>
