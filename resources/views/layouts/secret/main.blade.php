		...
		<script>
            $(document).ready(function(){
				...
				channel.bind('App\\Events\\MissionNotify', function(data) {
					...
					newNotificationHtml+='<img src="'+ data.avatar +'" alt="User Image" class="avatar-img rounded-circle" style="width:auto !important">';
