					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										...
										<li><a href="login.html">Check</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="col-lg-3 col-md-6">
								...
								<!-- Footer Widget -->
								<div class="footer-widget footer-menu">
									<h2 class="footer-title">For Consultant/Secretary</h2>
									<ul>
										<li><a href="appointments.html">Login</a></li>
										<li><a href="chat.html">Schedule</a></li>
										<li><a href="login.html">Appointment</a></li>
										<li><a href="doctor-register.html">Chat</a></li>
